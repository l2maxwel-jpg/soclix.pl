...
import { Mic2, Mail, Lock, Eye, EyeOff, User, ArrowRight } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" className="mt-1 rounded border-gray-300 text-emerald-500 focus:ring-emerald-500" required />
              <span className="text-sm text-gray-600 dark:text-gray-400">
                {t('auth.agreeTerms')}{' '}
                <a href="#" className="text-emerald-500 hover:text-emerald-600">{t('auth.termsOfService')}</a>
                {' '}{t('auth.and')}{' '}
                <a href="#" className="text-emerald-500 hover:text-emerald-600">{t('auth.privacyPolicy')}</a>
              </span>
            </div>
